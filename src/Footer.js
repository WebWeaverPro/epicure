    ...
    <footer className="bg-gray px-20 py-8">
      ...
      <div className="flex flex-row justify-between pb-8">
        <div className="flex flex-col py-8">
          ...
          <span className="text-base py-1 text-footer-text-color mt-2">
            Who are we
          </span>
          <span className="text-base py-1 text-footer-text-color">Blog</span>
          <span className="text-base py-1 text-footer-text-color">
            Work With us
          </span>
          <span className="text-base py-1 text-footer-text-color">
            Investor Relations
        ...
        <div className="flex flex-col py-8">
          <h3 className="text-base py-1 font-medium">Epiverse</h3>
          <span className="text-base py-1 text-footer-text-color mt-2">
            Epicure Enclave
          </span>
          <span className="text-base py-1 text-footer-text-color">
        ...
        <div className="flex flex-col py-8">
          <h3 className="text-base py-1 font-medium">For Resturants</h3>
          <span className="text-base py-1 text-footer-text-color mt-2">
            Partner With Us
          </span>
          <span className="text-base py-1 text-footer-text-color">
          ...
          <div className="mt-8">
            <h3 className="text-base py-1 font-medium">For EnterPrises</h3>
            <span className="text-base py-1 text-footer-text-color mt-2">
              Bhola Enterprise
            </span>
          </div>
        ...
        <div className="flex flex-col py-8">
          <h3 className="text-base py-1 font-medium">Learn More</h3>
          <span className="text-base py-1 text-footer-text-color mt-2">
            Privacy
          </span>
          <span className="text-base py-1 text-footer-text-color">Blog</span>
          ...
          <span className="text-base py-1 text-footer-text-color">Terms</span>
          <span className="text-base py-1 text-footer-text-color">
            Site Maps
          </span>
        </div>
        <div className="flex flex-col py-8">
          ...
          <div className="flex flex-row mt-2">
            <a href="https://google.com" className="mr-2">
              <div>
          ...
          <section className="mt-4">
            <a href="https://google.com" aria-label="app store link">
      ...
      <div className="border-t border-[#cccccc] pt-8"></div>
      <p className="text-sm text-footer-text-color">
        By continuing this page, you agree to our Terms of Service, Cookie
        Policy, Privacy Policy and Content Policies. All trademarks are
        properties of their respective owners. 2021-2023 © Epicure Ltd. All
        rights reserved.
      </p>
    </footer>
  );
